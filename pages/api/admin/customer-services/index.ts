...
import { adminGetCustomerServicesAndCount  } from "../../../../database/admin/customer_services";
  ...
  validateRole(["admin","super_admin"])(
    wrapMiddlewares(
      GET(async (req: NextApiRequest, res: NextApiResponse,user) => {
        ...
        const { count,results} = await adminGetCustomerServicesAndCount(conn)({filter,limit,skip,sort: sort as [string,string]})
