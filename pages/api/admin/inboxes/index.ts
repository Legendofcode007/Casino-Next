...
import { adminGetInboxesAndCount } from "../../../../database/admin/inbox"
  ...
  validateRole(["admin","super_admin"])(
    wrapMiddlewares(
      GET(async (req: NextApiRequest, res: NextApiResponse,user) => {
        ...
        const { count,results} = await adminGetInboxesAndCount(conn)({filter,limit,skip,sort: sort as [string,string]})
